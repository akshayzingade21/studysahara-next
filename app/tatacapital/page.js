...
import styles from "./tatacapital.module.css";
...
export default function TataCapital() {
  ...
  return (
    <>
      <Head>
        <title>Tata Capital Education Loan – StudySahara</title>
        <meta name="description" content="Tata Capital education loans with flexible repayment options. Great for students applying to top universities abroad." />
        <meta name="keywords" content="Tata Capital education loan, Tata Capital student loan, Tata Capital study abroad, Tata MS USA loan, Tata education loan India, non collateral loan Tata Capital" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta charSet="UTF-8" />
        <meta name="author" content="StudySahara" />
        <link rel="canonical" href="https://www.studysahara.com/tatacapital" />
      </Head>
      <div className={styles.tataContainer}>
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Tata Capital Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Empower your academic journey with Tata Capital’s education loans, offering up to ₹2 crore and competitive rates starting at 10.99% p.a.
                </p>
              ...
              <div className={styles.heroImage}>
                <div className={styles.imageWrapper}>
                  <Image
                    src="/images/tatacapital.png"
                    alt="Tata Capital Logo"
                    width={180}
                    height={180}
                    className={styles.tataImage}
                    onError={(e) => (e.target.src = "/images/tata-capital.png")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Tata Capital, a leading NBFC, offers education loans to support students pursuing higher education in India and abroad. With loans up to ₹85 lakh unsecured and ₹2 crore secured, Tata Capital covers 100% of education costs at competitive rates starting at 10.99% p.a.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}><span>✔</span> Loan Amount: Up to ₹85 lakh unsecured; ₹2 crore secured.</li>
                  <li className={styles.featureItem}><span>✔</span> Moratorium: Course duration + 1 year.</li>
                  <li className={styles.featureItem}><span>✔</span> Repayment Tenure: Up to 13 years.</li>
                  <li className={styles.featureItem}><span>✔</span> Margin: 100% financing of education costs.</li>
                  <li className={styles.featureItem}><span>✔</span> Rates: Starting at 10.99% p.a., based on profile.</li>
                  <li className={styles.featureItem}><span>✔</span> No Prepayment Penalty: Clear loan early without charges.</li>
                  <li className={styles.featureItem}><span>✔</span> Pre-admission Sanctions: Secure funding before admission.</li>
                  <li className={styles.featureItem}><span>✔</span> Tax Benefits: Deduction on interest under Section 80E.</li>
                </ul>
              </section>
                ...
                <div className={styles.eligibilityContent}>
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      <li>Indian citizen, aged 18–35 years.</li>
                      <li>Secured admission to a recognized institution.</li>
                      <li>Completed 10+2 with strong academics.</li>
                      <li>Entrance exam scores (GRE, GMAT, TOEFL, IELTS) for abroad studies.</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className={styles.subTitle}>Co-applicant:</h3>
                    <ul className={styles.eligibilityList}>
                      <li>Mandatory (parent, spouse, sibling, guardian).</li>
                      <li>Indian citizen with steady income and good credit history.</li>
                    </ul>
                  </div>
                </div>
              </section>
                ...
                <div className={styles.documentsContent}>
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Entrance exam scores (GRE, GMAT, TOEFL, IELTS).</li>
                      <li>Visa copy (for abroad studies).</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className={styles.subTitle}>Co-applicant:</h3>
                    <ul className={styles.documentsList}>
                      ...
                      <li>Income proof (3 months’ salary slips, 2 years’ ITR, 6 months’ bank statements).</li>
                  ...
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Collateral documents (for loans above ₹85 lakh).</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Tata Capital offers competitive interest rates with flexible repayment options and no prepayment penalties.
                </p>
                <div className={styles.tableContainer}>
                  <table className={styles.table}>
                    ...
                    <tbody>
                      <tr>
                        <td>Domestic (unsecured, up to ₹85 lakh)</td>
                        <td>11.50%–14.00%</td>
                        <td>0.5%–1% + GST</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                        <td>Abroad (unsecured, up to ₹85 lakh)</td>
                        <td>11.50%–14.00%</td>
                        <td>0.5%–1% + GST</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                        <td>Abroad (secured, up to ₹2 crore)</td>
                        <td>10.99%–13.00%</td>
                        <td>0.5%–1% + GST</td>
                        <td>Required</td>
                      </tr>
                ...
                <p className={styles.tableNote}>
                  *Rates vary based on profile, course, and institute. Contact Tata Capital for exact rates.
                </p>
              </section>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for Tata Capital options.</li>
                  <li><strong>Document Prep:</strong> Gather documents with our assistance.</li>
                  <li><strong>Application:</strong> Apply online via Tata Capital’s website, app, or offline at branches.</li>
                  <li><strong>Disbursal:</strong> Funds released post-approval, typically in 7–10 days.</li>
                </ol>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      What is the maximum loan amount from Tata Capital? <span id="faq1-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to ₹85 lakh without collateral; ₹2 crore with collateral for studies in India or abroad.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq2")}>
                      Is collateral required for Tata Capital education loans? <span id="faq2-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      No collateral is required for loans up to ₹85 lakh; required for loans above ₹85 lakh.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq3")}>
                      Are there tax benefits on Tata Capital education loans? <span id="faq3-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq3-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Yes, you can claim tax deductions on the interest paid under Section 80E for up to 8 years.
                    </p>
                  </div>
                </div>
              </section>
        ...
        <div id="applicationModal" className={`${styles.modalOverlay} ${isModalOpen ? styles.show : ""}`} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className={styles.modalTitle}>Tata Capital Education Loan Application</h2>
