...
import styles from "./avanse.module.css";
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Avanse Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Achieve your global education goals with Avanse Financial Services’ tailored loan solutions, offering 100% financing and flexible repayment.
                </p>
            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.documentsContent}>
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      <li>Admission letter or application proof.</li>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for Avanse options.</li>
                  <li><strong>Document Prep:</strong> We’ll assist with doorstep document collection.</li>
                  <li><strong>Application:</strong> Submit online with our support to Avanse.</li>
                  <li><strong>Disbursal:</strong> Funds released post-approval, including pre-visa options.</li>
                </ol>
