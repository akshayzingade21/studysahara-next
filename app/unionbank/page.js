...
import styles from "./unionbank.module.css";
      ...
      <div className={styles.unionbankContainer}>
            ...
            <aside className={`${styles.aside} ${styles.fadeIn}`}>
              <div className={styles.asideContent}>
                ...
                <ul className={styles.asideList}>
                  ...
                  <li><a href="#features" className={styles.asideLink}>Features</a></li>
                  ...
                  <li><a href="#application-process" className={styles.asideLink}>Process</a></li>
            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.documentsContent}>
                  ...
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Income proof (ITR, salary slips, Form-16, bank statements).</li>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  <li><strong>Submit Inquiry:</strong> Fill out our form.</li>
                  <li><strong>Expert Guidance:</strong> Consult our loan advisor.</li>
                  <li><strong>Document Prep:</strong> Gather documents with help.</li>
                  <li><strong>Application:</strong> Apply via Vidya Lakshmi or branch.</li>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to ₹40 lakh unsecured for abroad; no limit for secured loans.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Not for loans up to ₹40 lakh abroad or ₹4 lakh in India; required above.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
        ...
        <div id="applicationModal" className={`${styles.modalOverlay} ${isModalOpen ? styles.show : ""}`} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className={styles.modalTitle}>Union Bank Education Loan Application</h2>
            <form id="applicationForm" onSubmit={handleSubmit}>
              ...
              <div id="formStep2" className={`${styles.formStep} ${formStep === 2 ? "" : styles.hidden}`}>
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="university" className={styles.label}>University/College <span className={styles.required}>*</span></label>
                  <input
                    type="text"
                    id="university"
                    name="university"
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    required
                  />
                  <p id="course-error" className={styles.error} style={{ display: "none" }}>Please enter the course.</p>
                </div>
                <div className={styles.formGroup}>
                ...
                <div className={styles.formGroup}>
                  ...
                  >
                    ...
                    <option value="Applied for the university">Applied</option>
                    <option value="Received Offer/Admit letter">Received Offer</option>
                    <option value="Yet to apply for the university">Yet to Apply</option>
                  </select>
          ...
          <div className={styles.footerContent}>
            <div>
              ...
              <p className={styles.footerText}>
                Your partner in global education with tailored loan solutions.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <form className={styles.newsletterForm}>
                <input type="email" placeholder="Your email" className={`${styles.newsletterInput} ${styles.inputFocus}`} aria-label="Newsletter email" onFocus={(e) => e.target.classList.add(styles.inputActive)} onBlur={(e) => e.target.classList.remove(styles.inputActive)} />
