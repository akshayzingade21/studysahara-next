...
import styles from "./incred.module.css";
...
export default function InCredFinance() {
  ...
  return (
    <>
      <Head>
        <title>InCred Finance Education Loan - StudySahara</title>
        <meta name="description" content="Pursue your dreams with InCred’s education loans, offering up to ₹80 lakh unsecured and rates starting at 11.50% p.a." />
        <meta name="keywords" content="InCred Finance education loan, study abroad loan, education financing, StudySahara, loan without collateral" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta charSet="UTF-8" />
        <meta name="author" content="StudySahara" />
         <link rel="canonical" href="https://www.studysahara.com/incred" />
      </Head>
      <div className={styles.incredContainer}>
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>InCred Finance Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Pursue your dreams with InCred’s education loans, offering up to ₹80 lakh unsecured and rates starting at 11.50% p.a.
                </p>
              ...
              <div className={styles.heroImage}>
                <div className={styles.imageWrapper}>
                  <Image
                    ...
                    alt="InCred Finance Logo"
                    width={180}
                    height={180}
                    className={styles.incredImage}
                    onError={(e) => (e.target.src = "/images/incred.png")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  InCred Finance, a leading NBFC, offers education loans for students pursuing higher education in India and abroad. With loans up to ₹80 lakh unsecured and ₹1.5 crore secured, InCred covers 100% of education costs at competitive rates starting at 11.50% p.a.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}><span>✔</span> Loan Amount: Up to ₹80 lakh unsecured; ₹1.5 crore secured.</li>
                  <li className={styles.featureItem}><span>✔</span> Moratorium: Course duration + 6–12 months.</li>
                  <li className={styles.featureItem}><span>✔</span> Repayment Tenure: Up to 15 years.</li>
                  <li className={styles.featureItem}><span>✔</span> No Margin: 100% financing of education costs.</li>
                  <li className={styles.featureItem}><span>✔</span> Rates: 11.50%–14.00% p.a., concessions for top profiles.</li>
                  <li className={styles.featureItem}><span>✔</span> No Prepayment Penalty: Foreclose or prepay without charges.</li>
                  <li className={styles.featureItem}><span>✔</span> Online Process: Quick sanctions in 2–4 days.</li>
                </ul>
              </section>
                ...
                <div className={styles.eligibilityContent}>
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      <li>Indian citizen (or NRI/OCI/PIO with conditions).</li>
                      <li>Secured admission to a recognized institution.</li>
                      <li>Completed 10+2 with strong academics.</li>
                      <li>Age 21–32 years; qualified GRE/GMAT/TOEFL/IELTS (for abroad).</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className={styles.subTitle}>Co-applicant:</h3>
                    <ul className={styles.eligibilityList}>
                      <li>Mandatory (parent, spouse, guardian).</li>
                      <li>Indian citizen with steady income, CIBIL score ≥625.</li>
                    </ul>
                  </div>
                </div>
              </section>
                ...
                <div className={styles.documentsContent}>
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Course fee structure, visa, test scores (GRE/GMAT/TOEFL/IELTS).</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className={styles.subTitle}>Co-applicant:</h3>
                    <ul className={styles.documentsList}>
                      ...
                      <li>Credit report, notarized affidavit.</li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Proof of funds (if partial funding), collateral documents (for secured loans).</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  InCred Finance offers competitive interest rates with concessions for strong profiles and no prepayment penalties.
                </p>
                <div className={styles.tableContainer}>
                  <table className={styles.table}>
                    ...
                    <tbody>
                      <tr>
                        <td>Unsecured (up to ₹80 lakh)</td>
                        <td>11.75%–14.00%</td>
                        <td>0.75%–1.5% + GST</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                        <td>Abroad (unsecured, up to ₹80 lakh)</td>
                        <td>11.75%–13.75%</td>
                        <td>0.75%–1.5% + GST</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                        <td>Abroad (secured, up to ₹1.5 crore)</td>
                        <td>11.50%–13.00%</td>
                        <td>0.75%–1.5% + GST</td>
                        <td>Required</td>
                      </tr>
                ...
                <p className={styles.tableNote}>
                  *Rates vary based on profile, course, and institute. Contact InCred for exact rates.
                </p>
              </section>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for InCred options.</li>
                  <li><strong>Document Prep:</strong> Gather documents with our assistance.</li>
                  <li><strong>Application:</strong> Apply online via InCred website, app, or partners, or offline at branches.</li>
                  <li><strong>Disbursal:</strong> Funds released post-approval, typically in 2–4 days.</li>
                </ol>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      What is the maximum loan amount from InCred? <span id="faq1-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to ₹80 lakh without collateral; ₹1.5 crore with collateral for abroad studies.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Not required for loans up to ₹80 lakh; required for loans above ₹80 lakh.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq3")}>
                      Are there tax benefits? <span id="faq3-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq3-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      No, education loans from NBFCs like InCred do not offer tax benefits under Section 80E.
                    </p>
                  </div>
                </div>
              </section>
        ...
        <div id="applicationModal" className={`${styles.modalOverlay} ${isModalOpen ? styles.show : ""}`} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className={styles.modalTitle}>InCred Finance Education Loan Application</h2>
