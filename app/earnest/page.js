...
import styles from "./earnest.module.css";
...
export default function Earnest() {
  ...
  return (
    <>
      <Head>
        <title>Earnest Student Loans – US Education Financing Simplified | StudySahara</title>
        <meta name="description" content="Earnest offers student loans and refinancing options for studying in the US. Flexible repayment and low interest rates." />
        <meta name="keywords" content="Earnest education loan, Earnest US student loan, Earnest refinance, student loan USA, Earnest loan for masters, Earnest MS loan" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta charSet="UTF-8" />
        <meta name="author" content="StudySahara" />
         <link rel="canonical" href="https://www.studysahara.com/earnest" />
      </Head>
      <div className={styles.earnestContainer}>
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Earnest Education Loan for Indian Citizens</h1>
                <p className={styles.heroSubtitle}>
                  Pursue your US degree with Earnest’s no-fee loans, offering APRs from 5.99% and up to 100% cost of attendance coverage.
                </p>
              ...
              <div className={styles.heroImage}>
                <div className={styles.imageWrapper}>
                  <Image
                    src="/images/earnest.png"
                    alt="Earnest Logo"
                    width={180}
                    height={180}
                    className={styles.earnestImage}
                    onError={(e) => (e.target.src = "/images/earnest.png")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Earnest offers flexible, no-fee education loans for Indian international students pursuing degrees in the USA. Covering up to 100% of the cost of attendance with APRs starting at 5.99%, Earnest provides customizable repayment terms and a 9-month grace period.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}><span>✔</span> Loan Amount: Up to 100% COA, max $250,000.</li>
                  <li className={styles.featureItem}><span>✔</span> Grace Period: 9 months post-graduation.</li>
                  <li className={styles.featureItem}><span>✔</span> Repayment Tenure: 5–15 years, customizable.</li>
                  <li className={styles.featureItem}><span>✔</span> APRs: 5.99%–16.59% (fixed), 6.99%–18.00% (variable).</li>
                  <li className={styles.featureItem}><span>✔</span> No Fees: No origination, prepayment, or late fees.</li>
                  <li className={styles.featureItem}><span>✔</span> Flexible Payments: Interest-only, $25/month, or deferred.</li>
                  <li className={styles.featureItem}><span>✔</span> Credit Building: Builds US credit history.</li>
                  <li className={styles.featureItem}><span>✔</span> Rate Match: Matches competitor rates + $100 gift card.</li>
                </ul>
              </section>
                ...
                <div className={styles.eligibilityContent}>
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      ...
                      <li>Enrolled half-time in a Title IV, 4-year institution.</li>
                      <li>Physical US address (not PO box).</li>
                      <li>SSN/ITIN or Earnest placeholder.</li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      ...
                      <li>Credit score ≥ 650, ≥ 3 years credit history.</li>
                      <li>Annual income ≥ $35,000.</li>
                    </ul>
                  </div>
                </div>
              </section>
                ...
                <div className={styles.documentsContent}>
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      <li>Passport, US visa, SSN/ITIN (or placeholder).</li>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Earnest offers competitive fixed and variable APRs with no fees and a 0.25% autopay discount, ensuring cost-effective financing.
                </p>
                ...
                <p className={styles.tableNote}>
                  *APRs include 0.25% autopay discount. Rates vary based on credit and market conditions. Contact Earnest for personalized rates.
                </p>
              </section>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for Earnest options.</li>
                  <li><strong>Document Prep:</strong> Gather documents with our assistance.</li>
                  <li><strong>Application:</strong> Apply online via Earnest’s website.</li>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      Do Indian students need a co-signer for Earnest loans? <span id="faq1-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Yes, Indian international students require a US citizen or permanent resident co-signer with a credit score ≥ 650 and income ≥ $35,000.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to 100% of the school-certified cost of attendance per year, with a $250,000 aggregate limit.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq3")}>
                      Are there any fees for Earnest loans? <span id="faq3-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq3-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      No, Earnest charges no origination, prepayment, or late fees.
                    </p>
                  </div>
                </div>
              </section>
        ...
        <div id="applicationModal" className={`${styles.modalOverlay} ${isModalOpen ? styles.show : ""}`} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className={styles.modalTitle}>Earnest Education Loan Application</h2>
