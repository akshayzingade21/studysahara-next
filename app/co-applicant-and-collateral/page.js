...
import styles from "./co-applicant-and-collateral.module.css";
...
export default function LoanOption3() {
  ...
  return (
    <>
      <Head>
        <title>Co-Applicant & Collateral Loan | StudySahara</title>
        <meta
          name="description"
          content="Indian students aged 18-40, secure a co-applicant and collateral education loan for studying in USA, UK, Canada, Ireland, Germany, France, Australia, New Zealand, Italy, or Dubai. Apply now with StudySahara!"
        />
        <meta
          name="keywords"
          content="education loan India, study abroad loan India, co-applicant loan, collateral loan, loan for USA study, loan for UK study, loan for Canada study, loan for Ireland study, loan for Germany study, loan for France study, loan for Australia study, loan for New Zealand study, loan for Italy study, loan for Dubai study, Indian student loan abroad, StudySahara loan"
        />
        ...
        <meta property="og:title" content="Co-Applicant & Collateral Loan | StudySahara" />
        <meta
          property="og:description"
          content="Indian students (18-40) can get a co-applicant and collateral loan for studying in USA, UK, Canada, Ireland, Germany, France, Australia, New Zealand, Italy, or Dubai. Apply at StudySahara!"
        />
        <meta property="og:url" content="https://studysahara.com/co-applicant-and-collateral" />
        <meta property="og:type" content="website" />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content="Co-Applicant & Collateral Loan | StudySahara" />
        <meta
          property="twitter:description"
          content="Affordable loans for Indian students (18-40) to study in USA, UK, Canada, Ireland, Germany, France, Australia, New Zealand, Italy, or Dubai with co-applicant and collateral!"
        />
        <link rel="canonical" href="https://www.studysahara.com/co-applicant-and-collateral" />
      </Head>
        ...
        <main className={styles.main}>
          ...
          <section className={styles.infoSection}>
            <div className={styles.infoCard}>
              <h2 className={styles.sectionTitle}>What is Co-Applicant & Collateral Loan?</h2>
            ...
            <div className={styles.infoCard}>
              ...
              <ul className={styles.eligibilityList}>
                <li>Co-applicant with a stable income source.</li>
                <li>Clear and marketable collateral.</li>
            ...
            <div className={styles.infoCard}>
              ...
              <ul className={styles.featureList}>
                <li><span className={styles.checkIcon}>✔</span> Students who can provide assets as collateral.</li>
                <li><span className={styles.checkIcon}>✔</span> Students who are planning for Undergraduate course.</li>
                <li><span className={styles.checkIcon}>✔</span> Students seeking the lowest possible interest rates.</li>
                <li><span className={styles.checkIcon}>✔</span> Students seeking for higher loan amount. For Eg. loan amount of more than 1 crore rupees.</li>
              </ul>
            </div>
            <div className={styles.infoCard}>
