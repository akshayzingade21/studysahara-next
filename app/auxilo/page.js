...
import styles from "./auxilo.module.css";
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Auxilo Finserv Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Empower your academic dreams with Auxilo Finserv’s flexible education loans,
                  offering 100% financing and fast processing.
                </p>
          ...
          <div className={styles.contentGrid}>
            ...
            <div className={styles.mainContent}>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Auxilo Finserv offers competitive floating interest rates tailored to the student’s
                  academic profile and co-applicant’s financial strength.
                </p>
                ...
                <p className={styles.tableNote}>
                  *Rates are indicative and vary based on profile. Contact Auxilo for exact rates.
                </p>
              </section>
