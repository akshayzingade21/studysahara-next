...
import styles from "./idfc.module.css";
...
export default function IDFCBank() {
  ...
  return (
    <>
      <Head>
        <title>IDFC Bank Education Loan - StudySahara</title>
        <meta name="description" content="Explore education loans from IDFC Bank, offering up to ₹3 crore for international studies with flexible repayment options." />
        <meta name="keywords" content="IDFC Bank education loan, study abroad loan, education financing, StudySahara, loan without collateral" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta charSet="UTF-8" />
        <meta name="author" content="StudySahara" />
         <link rel="canonical" href="https://www.studysahara.com/idfc" />
      </Head>
      <div className={styles.idfcContainer}>
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>IDFC Bank Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Explore education loans from IDFC Bank, offering up to ₹3 crore for international studies with flexible repayment options.
                </p>
              ...
              <div className={styles.heroImage}>
                <div className={styles.imageWrapper}>
                  <Image
                    ...
                    width={180}
                    height={180}
                    className={styles.idfcImage}
                    onError={(e) => (e.target.src = "/images/idfc.png")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  IDFC Bank provides education loans up to ₹3 crore for international studies and ₹1 crore for domestic studies, featuring a digital process and no-collateral options for eligible students.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}><span>✔</span> Loan Amount: Up to ₹1 crore (India), ₹3 crore (abroad).</li>
                  <li className={styles.featureItem}><span>✔</span> Moratorium: Course duration + 12 months or 6 months post-employment.</li>
                  <li className={styles.featureItem}><span>✔</span> Repayment Tenure: Up to 15 years.</li>
                  <li className={styles.featureItem}><span>✔</span> Collateral: None up to ₹1 crore for premier institutes.</li>
                  <li className={styles.featureItem}><span>✔</span> Rates: 11.0%–12.5% p.a., with discounts for female students.</li>
                  <li className={styles.featureItem}><span>✔</span> Tax Benefits: Interest deductible under Section 80E.</li>
                  <li className={styles.featureItem}><span>✔</span> Fast Approval: Quick loan sanctions.</li>
                </ul>
              </section>
                ...
                <div className={styles.eligibilityContent}>
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      <li>Indian citizen, aged 16–35 years.</li>
                      <li>Confirmed admission to recognized institutions.</li>
                      <li>Minimum 50% marks in 10+2 or graduation.</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className={styles.subTitle}>Co-applicant:</h3>
                    <ul className={styles.eligibilityList}>
                      <li>Parent, sibling, spouse, or relative with stable income.</li>
                ...
                <div className={styles.documentsContent}>
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Academic records (10+2, graduation, entrance scores).</li>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  IDFC Bank offers competitive rates with special discounts for female students.
                </p>
                  ...
                  <table className={styles.table}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>11.0%–12.5% (10.75% for females)</td>
                        <td>1.5% + GST</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                ...
                <p className={styles.tableNote}>
                  *Rates vary based on profile. Contact IDFC Bank for exact rates.
                </p>
              </section>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for IDFC options.</li>
                  <li><strong>Document Prep:</strong> Gather documents with our assistance.</li>
                  <li><strong>Application:</strong> Apply online or in-branch.</li>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      What is the maximum loan amount from IDFC Bank? <span id="faq1-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to ₹1 crore for India, ₹3 crore for abroad.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Not required for loans up to ₹1 crore at premier institutes.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq3-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to 15 years, with a moratorium of course duration + 12 months or 6 months post-employment.
                    </p>
                  </div>
                </div>
              </section>
        ...
        <div id="applicationModal" className={`${styles.modalOverlay} ${isModalOpen ? styles.show : ""}`} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className={styles.modalTitle}>IDFC Bank Education Loan Application</h2>
