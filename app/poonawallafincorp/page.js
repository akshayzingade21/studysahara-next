...
import styles from "./poonawallafincorp.module.css";
...
export default function PoonawallaFincorp() {
  ...
  return (
    <>
      <Head>
        <title>Poonawalla Fincorp Education Loan – StudySahara</title>
        <meta
          name="description"
          content="Study abroad with Poonawalla Fincorp education loans. Fast approval, competitive rates, and no collateral options available."
        />
        <meta
          name="keywords"
          content="Poonawalla education loan, Poonawalla Fincorp student loan, study abroad loan Poonawalla, education loan India, Poonawalla MS loan, loan without security"
        />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta charSet="UTF-8" />
        <meta name="author" content="StudySahara" />
        <link rel="canonical" href="https://www.studysahara.com/poonawallafincorp" />
      </Head>
      <div className={styles.poonawallafincorpContainer}>
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Poonawalla Fincorp Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Pursue your dreams with Poonawalla Fincorp’s education loans, offering up to ₹3 crore and
                  competitive rates starting at 11.25% p.a.
                </p>
              ...
              <div className={styles.heroImage}>
                <div className={styles.imageWrapper}>
                  <Image
                    src="/images/poonawallafincorp.png"
                    alt="Poonawalla Fincorp Logo"
                    width={160}
                    height={145}
                    className={styles.poonawallaImage}
                    onError={(e) => (e.target.src = "/images/poonawalla-fincorp.png")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Poonawalla Fincorp, a leading NBFC, offers education loans to support students pursuing higher
                  education globally. With loans up to ₹1 crore unsecured and ₹3 crore secured, Poonawalla Fincorp
                  provides 100% financing at competitive rates starting at 11.25% p.a.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}>
                    <span>✔</span> Loan Amount: Up to ₹1 crore unsecured; ₹3 crore secured.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> Moratorium: Course duration + up to 1 year grace period.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> Repayment Tenure: Up to 15 years.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> No Margin: 100% financing of education costs.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> Rates: Starting at 11.25% p.a., based on profile.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> Instant Sanctions: Up to ₹75 lakh with quick approval.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> No Prepayment Penalty: After 6 EMIs from own funds.
                  </li>
                  <li className={styles.featureItem}>
                    <span>✔</span> Tax Benefits: Deduction on interest under Section 80E.
                  </li>
                </ul>
              </section>
              ...
              <section id="eligibility" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <div className={styles.eligibilityContent}>
                  ...
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      <li>Mandatory (parents, siblings, spouse, first cousins, parents’ siblings).</li>
                      <li>Indian citizen with stable income and good credit history.</li>
                      <li>Up to 5 co-applicants allowed.</li>
                    </ul>
                  </div>
                </div>
              </section>
                ...
                <div className={styles.documentsContent}>
                  ...
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Income proof (3 months’ salary slips, 2 years’ ITR, 3–6 months’ bank statements).</li>
                  ...
                  <div>
                    ...
                    <ul className={styles.documentsList}>
                      ...
                      <li>Collateral documents (for loans above ₹1 crore).</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Poonawalla Fincorp offers competitive interest rates with flexible repayment options and minimal
                  charges.
                </p>
                <div className={styles.tableContainer}>
                  <table className={styles.table}>
                    ...
                    <tbody>
                      <tr>
                        <td>Domestic (unsecured, up to ₹1 crore)</td>
                        <td>11.25%–14.00%</td>
                        <td>Up to 2% + GST (min. ₹5,000)</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                        <td>Abroad (unsecured, up to ₹1 crore)</td>
                        <td>11.25%–14.00%</td>
                        <td>Up to 2% + GST (min. ₹5,000)</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
                        <td>Abroad (secured, up to ₹3 crore)</td>
                        <td>11.25%–13.50%</td>
                        <td>Up to 2% + GST (min. ₹5,000)</td>
                        <td>Required</td>
                      </tr>
                ...
                <p className={styles.tableNote}>
                  *Rates vary based on profile, course, and institute. Contact Poonawalla Fincorp for exact rates.
                </p>
              </section>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li>
                    <strong>Expert Guidance:</strong> Connect with our loan advisor for Poonawalla Fincorp options.
                  </li>
                  <li>
                    <strong>Document Prep:</strong> Gather documents with our assistance.
                  </li>
                  <li>
                    <strong>Application:</strong> Apply online via Poonawalla Fincorp’s website or app.
                  </li>
                  <li>
                    <strong>Disbursal:</strong> Funds released post-verification, typically within days.
                  </li>
                </ol>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      What is the maximum loan amount from Poonawalla Fincorp?{" "}
                      <span id="faq1-icon" className={styles.faqIcon}>
                        +
                      </span>
                    </h3>
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to ₹1 crore without collateral; ₹3 crore with collateral for studies in India or abroad.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq2")}>
                      Is collateral required for Poonawalla Fincorp education loans?{" "}
                      <span id="faq2-icon" className={styles.faqIcon}>
                        +
                      </span>
                    </h3>
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      No collateral is required for loans up to ₹1 crore; required for loans above ₹1 crore.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq3")}>
                      Are there tax benefits on Poonawalla Fincorp education loans?{" "}
                      <span id="faq3-icon" className={styles.faqIcon}>
                        +
                      </span>
                    </h3>
        ...
        >
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            ></div>
            <h2 className={styles.modalTitle}>Poonawalla Fincorp Education Loan Application</h2>
