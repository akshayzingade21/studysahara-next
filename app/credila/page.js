...
export default function Credila() {
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Credila Education Loan</h1>
                <p className={styles.heroSubtitle}>
                  Transform your study abroad dreams into reality with tailored financing from Credila Financial Services.
                </p>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Credila Financial Services, formerly HDFC Credila, is India’s first dedicated education loan NBFC, offering customized financing for students pursuing higher education in India and abroad. Covering over 4,600 institutions across 64 countries, Credila provides flexible loan options, competitive interest rates, and pre-admission approval to ease financial planning.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}><span>✔</span> Loan Amount: No upper limit; up to ₹1 crore without collateral, higher with collateral.</li>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for Credila options.</li>
                  <li><strong>Document Prep:</strong> We’ll help collect required documents.</li>
                  <li><strong>Application:</strong> Submit with our assistance to Credila.</li>
