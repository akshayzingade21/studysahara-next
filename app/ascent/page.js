...
export default function AscentLoan() {
  ...
  return (
    <>
      <Head>
        <title>Ascent Education Loan for Indian Citizens - StudySahara</title>
        <meta name="description" content="Fund your US education with Ascent’s no-fee loans, offering APRs from 3.79% and up to 100% cost of attendance coverage for Indian citizens." />
        <meta name="keywords" content="Ascent education loan, study abroad loan, US education financing, Indian students loan, StudySahara, no-fee loans" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta charSet="UTF-8" />
        <meta name="author" content="StudySahara" />
        <link rel="canonical" href="https://www.studysahara.com/ascent" />
      </Head>
      <div className={styles.ascentContainer}>
          ...
          <section className={`${styles.hero} ${styles.fadeIn}`}>
            <div className={styles.heroContent}>
              <div className={styles.heroText}>
                <h1 className={styles.heroTitle}>Ascent Education Loan for Indian Citizens</h1>
                <p className={styles.heroSubtitle}>
                  Fund your US education with Ascent’s no-fee loans, offering APRs from 3.79% and up to 100% cost of attendance coverage.
                </p>
              ...
              <div className={styles.heroImage}>
                <div className={styles.imageWrapper}>
                  <Image
                    ...
                    onError={(e) => (e.target.src = "/images/ascent.png")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className={styles.mainContent}>
              <section id="overview" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Ascent offers flexible, no-fee education loans for Indian international students pursuing degrees in the USA. Covering up to 100% of the cost of attendance with APRs starting at 3.79%, Ascent provides customizable repayment terms and a 9-month grace period.
                </p>
              </section>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  <li className={styles.featureItem}><span>✔</span> Loan Amount: $2,001 to 100% COA ($6,001 in MA).</li>
                  <li className={styles.featureItem}><span>✔</span> Grace Period: 9 months post-graduation.</li>
                  <li className={styles.featureItem}><span>✔</span> Repayment Tenure: 5–20 years, depending on program.</li>
                  <li className={styles.featureItem}><span>✔</span> APRs: 3.79%–15.99% (fixed), 4.29%–16.69% (variable).</li>
                  <li className={styles.featureItem}><span>✔</span> No Fees: No application, origination, or prepayment fees.</li>
                  <li className={styles.featureItem}><span>✔</span> Flexible Payments: Deferred, interest-only, or $25 minimum.</li>
                  <li className={styles.featureItem}><span>✔</span> Credit Building: Builds US credit history.</li>
                  <li className={styles.featureItem}><span>✔</span> Graduation Reward: 1% cash-back upon degree completion.</li>
                </ul>
              </section>
                ...
                <div className={styles.eligibilityContent}>
                  ...
                  <div>
                    ...
                    <ul className={styles.eligibilityList}>
                      ...
                      <li>Credit score ≥ 650, ≥ 2 years credit history.</li>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  Ascent offers competitive fixed and variable APRs with no application or prepayment fees, plus a 0.25% autopay discount.
                </p>
                ...
                <p className={styles.tableNote}>
                  *APRs include 0.25% autopay discount. Rates vary based on credit and market conditions. Contact Ascent for personalized rates.
                </p>
              </section>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for Ascent options.</li>
                  <li><strong>Document Prep:</strong> Gather documents with our assistance.</li>
                  <li><strong>Application:</strong> Apply online via Ascent’s website.</li>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      Do Indian students need a cosigner for Ascent loans? <span id="faq1-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Yes, Indian international students require a US citizen or permanent resident cosigner with a credit score ≥ 650 and stable income.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    ...
                    <p id="faq2-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      Up to 100% of the school-certified cost of attendance per year, with a $200,000 limit for undergraduate and $400,000 for graduate programs.
                    </p>
                  </div>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq3")}>
                      Are there any fees for Ascent loans? <span id="faq3-icon" className={styles.faqIcon}>+</span>
                    </h3>
                    <p id="faq3-answer" className={styles.faqAnswer} style={{ display: "none" }}>
                      No application, origination, or prepayment fees. Late fees are 5% of the past-due amount, up to $25, and returned payment fees are up to $28.
                    </p>
                  </div>
                </div>
              </section>
        ...
        <div id="applicationModal" className={`${styles.modalOverlay} ${isModalOpen ? styles.show : ""}`} onClick={closeModal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className={styles.modalTitle}>Ascent Education Loan Application</h2>
