...
export default function PNBBank() {
...
<>
<Head>
<title>Punjab National Bank Education Loan - StudySahara</title>
<meta name="description" content="Achieve your academic goals with PNB’s education loans, offering flexible financing up to ₹7.5 lakh without collateral and competitive rates." />
<meta name="keywords" content="Punjab National Bank education loan, study abroad loan, education financing, StudySahara, loan without collateral" />
...
<h1 className={styles.heroTitle}>Punjab National Bank Education Loan</h1>
<p className={styles.heroSubtitle}>
Achieve your academic goals with PNB’s education loans, offering flexible financing up to ₹7.5 lakh without collateral and competitive rates.
</p>
...
onError={(e) => (e.target.src = "/images/pnb.png")}
/>
</div>
</div>
</div>
...
Punjab National Bank (PNB), a leading public sector bank, offers education loans under schemes like PNB Saraswati, Pratibha, Udaan, and Kaushal to support students pursuing higher education in India and abroad. With no upper limit for secured loans and rates starting at 9.00% p.a., PNB ensures affordable financing.
</p>
</section>
...
<li className={styles.featureItem}><span>✔</span> Loan Amount: Up to ₹7.5 lakh unsecured; no limit for secured loans.</li>
...
<li className={styles.featureItem}><span>✔</span> Margin: Nil up to ₹4 lakh; 5% (India), 15% (abroad) above ₹4 lakh.</li>
<li className={styles.featureItem}><span>✔</span> Rates: 9.00%–12.75% p.a., with concessions for females.</li>
<li className={styles.featureItem}><span>✔</span> Subsidies: CSIS for EWS, benefits for PwDs.</li>
...
<li>Indian national (or OCI for Pravasi Shiksha scheme).</li>
<li>Secured admission via entrance exams or merit to recognized institutions.</li>
<li>Pass marks in last qualifying exam (relaxation for SC/ST).</li>
</ul>
</div>
<div>
<h3 className={styles.subTitle}>Co-applicant:</h3>
<ul className={styles.eligibilityList}>
<li>Mandatory for non-collateral loans (parent, spouse, guardian, in-laws).</li>
...
<li>Passport-size photographs, visa (for abroad).</li>
</ul>
</div>
<div>
<h3 className={styles.subTitle}>Co-applicant:</h3>
...
<li>Income proof (ITR, salary slips, Form-16, 12 months’ bank statements).</li>
...
<li>Collateral documents, ECS/NACH form, post-dated cheques (if applicable).</li>
</ul>
</div>
</div>
</section>
...
<p className={styles.sectionText}>
PNB offers competitive interest rates, with concessions for female students and interest servicing during moratorium.
</p>
...
<tbody>
<tr>
<td>Unsecured (up to ₹7.5 lakh)</td>
<td>10.25%–12.75% (11.75% for females)</td>
<td>1% (min. ₹10,000, refundable)</td>
<td>Not required</td>
</tr>
<tr>
<td>Secured (above ₹7.5 lakh)</td>
<td>9.00%–11.50%</td>
<td>1% (min. ₹10,000, refundable)</td>
<td>Required</td>
</tr>
...
*Rates vary based on profile and institute. Contact PNB for exact rates.
</p>
</section>
...
<li><strong>Expert Guidance:</strong> Connect with our loan advisor for PNB options.</li>
<li><strong>Document Prep:</strong> Gather documents with our assistance.</li>
<li><strong>Application:</strong> Apply online via Vidya Lakshmi portal or offline at branches.</li>
<li><strong>Disbursal:</strong> Funds released to institute or account post-approval.</li>
</ol>
...
What is the maximum loan amount from PNB? <span id="faq1-icon" className={styles.faqIcon}>+</span>
</h3>
<p id="faq1-answer" className={styles.faqAnswer} style={{ display: "none" }}>
Up to ₹7.5 lakh without collateral; no upper limit for secured loans, based on need and collateral value.
</p>
</div>
<div className={styles.faqItem}>
...
Not required for loans up to ₹7.5 lakh; required for higher amounts.
</p>
</div>
<div className={styles.faqItem}>
...
Up to 15 years, with a moratorium of course duration + 1 year.
</p>
</div>
</div>
</section>
...
<h2 className={styles.modalTitle}>Punjab National Bank Education Loan Application</h2>
