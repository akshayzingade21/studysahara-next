...
import styles from "./icicibank.module.css";
            ...
            <div className={styles.mainContent}>
              ...
              <section id="features" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ul className={styles.featuresList}>
                  ...
                  <li className={styles.featureItem}><span>✔</span> Rates: 11.25%–13% p.a., 0.5% concession for girl students.</li>
                  <li className={styles.featureItem}><span>✔</span> Tax Benefits: Full interest deductible under Section 80E.</li>
                  <li className={styles.featureItem}><span>✔</span> Instant Sanction: Pre-approved loans in minutes.</li>
                </ul>
              </section>
              ...
              <section id="interest-rates" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <p className={styles.sectionText}>
                  ICICI Bank offers competitive rates with concessions for girl students.
                </p>
                  ...
                  <table className={styles.table}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>11.25%–13% (11.75% for females)</td>
                        <td>2% + GST</td>
                        <td>Not required</td>
                      </tr>
                      <tr>
              ...
              <section id="application-process" className={`${styles.section} ${styles.fadeInUp}`}>
                ...
                <ol className={styles.processList}>
                  ...
                  <li><strong>Expert Guidance:</strong> Connect with our loan advisor for ICICI options.</li>
                ...
                <div className={styles.faqs}>
                  <div className={styles.faqItem}>
                    <h3 className={styles.faqQuestion} onClick={() => toggleFAQ("faq1")}>
                      What is the maximum loan amount from ICICI Bank? <span id="faq1-icon" className={styles.faqIcon}>+</span>
                    </h3>
